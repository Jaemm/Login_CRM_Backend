...
import { ConsultantBranchesController } from './consultantBranches.controller';
...
@Module({
  ...
  controllers: [ConsultantBranchesController],
  providers: [ConsultantBranchesService],
  exports: [ConsultantBranchesService],
})
export class ConsultantBranchesModule {}
