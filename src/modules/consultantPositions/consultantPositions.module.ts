...
import { ConsultantPositionsController } from './consultantPositions.controller';
...
@Module({
  ...
  controllers: [ConsultantPositionsController],
  providers: [ConsultantPositionsService],
  exports: [ConsultantPositionsService],
})
export class ConsultantPositionsModule {}
